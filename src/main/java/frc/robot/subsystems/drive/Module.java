...
public class Module {
  ...
  /** Runs the module with the specified output while controlling to the specified angle. */
  public void runDriveCharacterization(double output, Rotation2d angle) {
