...
public final class ChoreoVars {
  ...
  public static final class Poses {
    public static final Pose2d ClimbSetupOutpost =
        new Pose2d(1.035, 2.65, Rotation2d.fromRadians(-1.571));
    public static final Pose2d ClimbSetupDepot =
        new Pose2d(1.035, 4.9, Rotation2d.fromRadians(1.571));
    public static final Pose2d ClimbDepot = new Pose2d(1.035, 4.569, Rotation2d.fromRadians(1.571));
