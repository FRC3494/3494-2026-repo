...
public final class ChoreoVars {
    ...
    public static final class Poses {
        ...
        public static final Pose2d NZDepotShootingTarget = new Pose2d(3, 6.043, Rotation2d.kZero);
        public static final Pose2d NZOutpostShootingTarget = new Pose2d(3, 1.957, Rotation2d.kZero);
