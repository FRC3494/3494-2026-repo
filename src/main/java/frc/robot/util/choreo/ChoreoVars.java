...
public final class ChoreoVars {
    public static final LinearVelocity MaxVelocity = Units.MetersPerSecond.of(1);
    ...
    public static final Distance DepotIntakeStop = Units.Meters.of(0.203);
    public static final LinearVelocity DropIntakeMaxVelocity = Units.MetersPerSecond.of(5);
    ...
    public static final class Poses {
        ...
        public static final Pose2d ClimbDepot = new Pose2d(1.155, 4.509, Rotation2d.fromRadians(1.571));
        public static final Pose2d ClimbSetupDepot = new Pose2d(1.155, 4.9, Rotation2d.fromRadians(1.571));
        public static final Pose2d ClimbSetupOutpost = new Pose2d(1.155, 2.65, Rotation2d.fromRadians(-1.571));
        ...
        public static final Pose2d DepotIntake = new Pose2d(1.391, 5.969, Rotation2d.fromRadians(3.142));
