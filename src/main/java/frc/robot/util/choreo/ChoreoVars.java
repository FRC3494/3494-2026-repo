...
public final class ChoreoVars {
    ...
    public static final class Poses {
        ...
        public static final Pose2d ClimbDepot = new Pose2d(1.13, 4.509, Rotation2d.fromRadians(1.571));
        public static final Pose2d ClimbOutpost = new Pose2d(1.109, 2.957, Rotation2d.fromRadians(-1.571));
        public static final Pose2d ClimbSetupDepot = new Pose2d(1.13, 4.9, Rotation2d.fromRadians(1.571));
        public static final Pose2d ClimbSetupOutpost = new Pose2d(1.109, 2.65, Rotation2d.fromRadians(-1.571));
