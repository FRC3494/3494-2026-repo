...
public final class ChoreoVars {
    ...
    public static final LinearAcceleration NZMaxAcceleration = Units.MetersPerSecondPerSecond.of(4.5);
    public static final LinearVelocity NZMaxVelocity = Units.MetersPerSecond.of(4.5);
    public static final Distance RobotBumperSize = Units.Meters.of(0.448);
    public static final LinearVelocity RobotMaxSpeed = Units.MetersPerSecond.of(4.56);
    ...
    public static final class Poses {
        ...
        public static final Pose2d LeftNZ = new Pose2d(7.928, 7, Rotation2d.fromRadians(-1.833));
        public static final Pose2d LeftTrenchStartingPosition = new Pose2d(4.476, 7.596, Rotation2d.fromRadians(3.142));
        public static final Pose2d MiddleNZ = new Pose2d(7.928, 5.476, Rotation2d.fromRadians(-1.833));
