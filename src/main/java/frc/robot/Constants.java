...
public final class Constants {
  ...
  public static class DriveConstants {
    ...
    */
    ...
    // ! Gears on the right
    public static final Rotation2d frontLeftZeroRotation = Rotation2d.fromRadians(1.233);
    public static final Rotation2d frontRightZeroRotation = Rotation2d.fromRadians(3.377);
    public static final Rotation2d backLeftZeroRotation = Rotation2d.fromRadians(1.408);
    public static final Rotation2d backRightZeroRotation = Rotation2d.fromRadians(4.062);
  ...
  public static final class HopperConstants {
    ...
    public static double spindexerUnjamMotorRotations = 2.0;
  ...
  public static final class ShooterConstants {
    ...
    public static final class FlywheelConstants {
      ...
      public static double flywheelSpeedupKa = 0.0002;
